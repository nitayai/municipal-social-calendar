      ...
      <div className="grid gap-4 sm:gap-5 sm:grid-cols-3">
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-semibold group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">ניהול מחלקות</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">הוסף ועדכן מחלקות</p>
            </div>
          </div>
        </Link>
      </div>
