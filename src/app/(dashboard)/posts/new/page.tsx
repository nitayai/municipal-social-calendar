        ...
        if (cloneFromId) {
          ...
          if (sourcePost) {
            ...
            setFormData({
              ...
              suggested_tags: sourcePost.suggested_tags || "",
              design_suggestions: sourcePost.design_suggestions || "",
            });
          }
        }
      } catch { /* ignore */ }
    ...
    <div>
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white dark:bg-[#141414] rounded-xl border border-gray-200 dark:border-[#2a2a2a] p-4 sm:p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 p-4 bg-blue-50/50 dark:bg-blue-900/10 rounded-lg border border-blue-100 dark:border-blue-900/30">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-sm font-medium text-blue-700 dark:text-blue-300">הצעות AI לפוסט</span>
              <span className="text-xs text-gray-400">(אופציונלי)</span>
            </div>
            <div>
              <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">הצעות לתיוגים (hashtags)</label>
              <input
                type="text"
                value={formData.suggested_tags}
                onChange={e => setFormData({ ...formData, suggested_tags: e.target.value })}
                placeholder="#ישראל #יהוד #קהילה ..."
                dir="ltr"
            ...
            <div>
              <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">הצעות לעיצוב</label>
              <textarea
                value={formData.design_suggestions}
                onChange={e => setFormData({ ...formData, design_suggestions: e.target.value })}
                rows={2}
                placeholder="תמונה של הפארק בשקיעה, צבעי מותג כחול-לבן, לוגו בפינה ימנית..."
                className="w-full px-3 py-2 border border-gray-300 dark:border-[#3a3a3a] rounded-lg bg-white dark:bg-[#1f1f1f] text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
              />
            </div>
          </div>
