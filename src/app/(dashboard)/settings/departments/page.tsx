...
export default function DepartmentsPage() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-6">ניהול מחלקות</h2>
      ...
      <div className="bg-white dark:bg-gray-900 shadow rounded-lg p-6 max-w-2xl">
        ...
        <div className="divide-y divide-gray-200 dark:divide-gray-700">
          {departments.length === 0 ? (
            <p className="text-gray-500 py-4 text-center">אין מחלקות</p>
          ) : (
                ...
                {editingId === dept.id ? (
                  <div className="flex items-center gap-2 flex-1">
                    <input
                      ...
                      className="flex-1 px-3 py-1 border border-gray-300 dark:border-gray-700 rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-blue-500"
                      autoFocus
                    />
                    <button
